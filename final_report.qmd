...
::: {.column width="50%"}
<figure>
  <img src="Presentation/Chess-Board-with-Boxes.png" width="80%" class="shadow padded">
...
::: {.column width="50%"}
<figure>
  <img src="Presentation/Chess-Board-without-Boxes.jpg" width="80%" class="shadow padded">
...
<figure style="text-align: center;">
  <img src="Presentation/Model_Achitecture_Image.png"
       width="60%"
...
<figure style="text-align: center;">
  <img src="Presentation/Version_6_Board_Error_Distribution.png"
       width="60%"
       style="padding: 12px; background-color: white; box-shadow: 0px 6px 12px rgba(0, 0, 0, 0.25); border-radius: 6px;">
...
<figure style="text-align: center;">
  <img src="Presentation/Version_6_Test_Set_Confusion_Matrix.png"
       width="60%"
       style="padding: 12px; background-color: white; box-shadow: 0px 6px 12px rgba(0, 0, 0, 0.25); border-radius: 6px;">
  <figcaption>Fig. 6: Confusion matrix on the held out test set for per-square predictions across 13 classes. Most errors are off-diagonal confusions between visually similar pieces, such as bishops/pawns or queens/rooks, particularly under black/white variants.</figcaption>
</figure>
...
### 6.3 Qualitative Board-Level Predictions
...
<figure style="text-align: center;">
  <img src="Presentation/Version_6_Near_Perfect_Predict.png"
       width="95%"
       style="padding: 12px; background-color: white; box-shadow: 0px 6px 12px rgba(0, 0, 0, 0.25); border-radius: 6px;">
...
<figure style="text-align: center;">
  <img src="Presentation/loss_plot.png"
       width="70%"
       style="padding: 12px; background-color: white; box-shadow: 0px 6px 12px rgba(0, 0, 0, 0.25); border-radius: 6px;">
